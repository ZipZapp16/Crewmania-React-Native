            ...
            <Grid templateColumns="repeat(12, 1fr)" gap={2} height={'90vh'} marginTop={{base:'5vh', lg:'80px'}}>
                    ...
                    <form onSubmit={handleSubmit} style={{ margin: 'auto' }}>
                        <Flex direction={'column'} justifyContent={'center'} whiteSpace={'between'}>
                            ...
                            <FormControl id="username" marginX={'auto'} >
                                <FormLabel fontSize={{base:'18px', lg:'22px'}} >{t('login.username')}</FormLabel>
                                <InputGroup>
                            ...
                            <FormControl id="password" marginX={'auto'}  >
                                <FormLabel fontSize={{base:'18px', lg:'22px'}}  >{t('login.password')}</FormLabel>
                                <InputGroup>
                            ...
                            <Button type="submit" width={'100%'} minHeight={{base:'38px', lg:'64px'}} bg="#4054A9" color="white" fontSize={{base:'16',lg:'20'}} borderRadius={'lg'} flex='1'>{t('login.button')}</Button>
                            </Box>
                        </Flex>
                    </form>
                </GridItem>
                ...
                <GridItem colStart={{base: 2, lg: 6}} colEnd={12}  textAlign={'center'} height={'30%'}>
                    <Flex justifyContent={'center'} width={'100%'} minHeight={'34px'}>
                        ...
                        <Text fontSize={{base:'14px', lg:'20px'}}  color='#C8C8C8' marginY={'3px'}>{t('login.other')}</Text>
                        </Box>
                        <Box borderTop="2px solid #DADADA" marginX="auto" width="25%" height={'2px'} marginY={'auto'}/>
                    </Flex>
                    ...
                    <Text fontSize={{base:'14px', lg:'18px'}} marginY={'8px'}>{t('login.noAccount')} <a href="/signup" style={{ color: 'blue', textDecoration: 'underline' }}>{t('login.register')}</a></Text>
                </GridItem>
            </Grid>
        </div>
    );
